# match is the regex you want to trigger the bot.
# message is what to send to the sound player,
# it needs to match the filename of the sound.
# spaces will be converted to underscores,
# ex: if you send "do it" the file MUST be called do_it.mp3
